...
const colorData = [
  { color: '#C5F1FB', image: vs_blue, name: 'Xanh' },
  { color: '#F30D0D', image: vs_red, name: 'Đỏ' },
  { color: '#000000', image: vs_black, name: 'Đen' },
  { color: '#234896', image: vs_silver, name: 'Bạc' },
];
...
Hàng chính hãng</Text>
      ...
      <View style={{backgroundColor: '#C4C4C4', flexDirection:'column', flex: 1}}>
        ...
        <View style={{flexDirection:'column', justifyContent: 'center', alignItems:'center'}}>
          <TouchableOpacity style={{width:80, height: 80, marginTop: 10, backgroundColor:'#C5F1FB'}}>
          </TouchableOpacity>
          <TouchableOpacity style={{width:80, height: 70, marginTop: 10, backgroundColor:'#F30D0D'}}>
          </TouchableOpacity>
          <TouchableOpacity style={{width:80, height: 80, marginTop: 10, backgroundColor:'#000000'}}>
          </TouchableOpacity>
          <TouchableOpacity style={{width:80, height: 80, marginTop: 10, backgroundColor:'#234896'}}>
          </TouchableOpacity>
        </View>
...
//         <Image source={vs_blue} style={{ width: 250, height: 300}}/>
//       </View>
